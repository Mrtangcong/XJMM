<template>
  <div>
    ...
    <!-- modal -->
      ...
      <Modal v-model="assigncaseModal1" title="分配案件">
        <div class="box1">
          <div>
      ...
      <Modal v-model="assigncaseModal2" title="一键均分案件">
        <div class="box1">
          <div>
            <Button type="text" >选择催收人员</Button>
            <Select clearable v-model="mcuiPerson" style="width:200px" size="large">
        ...
        <div slot="footer">
            ...
            <Button type="primary" @click="yes2">确认转入</Button>
        </div>
      </Modal>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    searchTable(){  //我的工作台查询
      var that = this;
      axios.post('http://192.168.0.188:8088/due/casedivide/dueNotDivide', {
        "acceptor": that.maccepter,
        // "caseStatus": that.mcaseStatus,
        // "duaDateMax": that.staData,
        // "duaDateMin": that.endData,
        // "duaType": that.moverType,
        "name": that.name,
